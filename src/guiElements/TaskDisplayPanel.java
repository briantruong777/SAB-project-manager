...
public class TaskDisplayPanel extends JPanel implements ActionListener, MouseListener
{
	...
	public TaskDisplayPanel(Task task, TaskPanel panel)
	{
		...
		statusLabel = new JLabel(new ImageIcon(cl.getResource("res/unstarted.png")), JLabel.LEFT);
		add(statusLabel);

		mhorizontalStrut_4 = Box.createHorizontalStrut(5);
		add(mhorizontalStrut_4);

		brokenResourceLabel = new JLabel(new ImageIcon(cl.getResource("res/broken_part.png")), JLabel.LEFT);
		...
		workingButton = new JButton(new ImageIcon(cl.getResource("res/work.png")));
		...
		mradioNotesButton = new JRadioButton(new ImageIcon(cl.getResource("res/notes.png")));
		...
		mradioLinkButton = new JRadioButton(new ImageIcon(cl.getResource("res/folder.png")));
	...
	private void enableButtons()
	{
		...
		switch (task.getStatus())
		{
			...
			case UNSTARTED:
				...
				statusLabel.setIcon(new ImageIcon(cl.getResource("res/unstarted.png")));
			...
			case PAUSED:
				...
				if (task.getUndoCompleted())
				{
					statusLabel.setIcon(new ImageIcon(cl.getResource("res/pause_square.png")));
					statusLabel.setToolTipText("Paused Task (Undo-completed)");
				}
				else
				{
					statusLabel.setIcon(new ImageIcon(cl.getResource("res/pause.png")));
			...
			case WORKING:
				...
				if (task.getUndoCompleted())
				{
					statusLabel.setIcon(new ImageIcon(cl.getResource("res/work_square.png")));
					statusLabel.setToolTipText("Working Task (Undo-completed)");
				}
				else
				{
					statusLabel.setIcon(new ImageIcon(cl.getResource("res/work.png")));
			...
			case COMPLETE:
				...
				if (task.checkDependenciesUndoCompleted())
				{
					statusLabel.setIcon(new ImageIcon(cl.getResource("res/complete_red.png")));
				...
				{
					statusLabel.setIcon(new ImageIcon(cl.getResource("res/complete.png")));
				}
				statusLabel.setToolTipText(toolTip);
